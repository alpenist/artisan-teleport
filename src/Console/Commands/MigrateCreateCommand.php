...
use Ait\ArtisanTeleport\Console\BaseMigrationCommand;
...
class MigrateCreateCommand extends BaseMigrationCommand
{
    /**
    ...
    protected function getMigrationPath()
    {
        if (! is_null($targetPath = $this->input->getOption('path'))) {
            return ! $this->usingRealPath()
                ? $this->configAssetsPath() . '/' . $targetPath//$this->laravel->basePath().'/'.$targetPath
                : $targetPath;
        }
